...
## Nota de implementación (sustitutos de fuente usados en este repo)

Las fuentes originales son comerciales. Sustitutos libres instalados vía @fontsource:
- Neue Montreal → **Switzer** (Fontshare, servida local en `public/fonts/`)
- Louize Display / Louize → **Instrument Serif** (display) + **Lora** (copy editorial)
- Manuka → **Anton** (ultra-condensada, familia Druk)

Los tokens CSS verbatim del sistema están al final de este archivo, en `henry.css`
se aplican scoped bajo `.design-henry`.

## Quick Start — CSS Custom Properties (verbatim)
...
:root {
  ...
  /* Typography — Scale */
  --text-caption: 12px;   --leading-caption: 1.5;    --tracking-caption: -0.12px;
  ...
  --text-heading-sm: 24px;--leading-heading-sm: 1.2; --tracking-heading-sm: -0.24px;
  --text-heading: 32px;   --leading-heading: 1.1;    --tracking-heading: -0.32px;
  --text-heading-lg: 77px;--leading-heading-lg: 0.9;
  --text-display: 132px;  --leading-display: 0.8;
  --text-display-xl: 371px;--leading-display-xl: 0.75;
  ...
  --spacing-20: 20px; --spacing-24: 24px; --spacing-32: 32px; --spacing-64: 64px;
  --spacing-80: 80px; --spacing-224: 224px;
  ...
  /* Border Radius */
  --radius-xl: 12px;
  --radius-tags: 12px; --radius-cards: 12px; --radius-buttons: 12px;
