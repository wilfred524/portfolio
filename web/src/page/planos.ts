 ...
 *
 * Presentación, no contenido: el reparto vive aquí y no en `profile.*.ts`, del que salen
 * también el CV y la paridad entre idiomas. Cambiar el guion no debe arrastrarlos.
 *
 * El `id` viaja en la URL y es el mismo en los dos idiomas: un enlace enviado en una
 * postulación no puede romperse porque el visitante cambie de idioma.
 */
...
export const PLANOS: Plano[] = [
  ...
  /* Reparto 3 / 4 / 2 por criterio temático: así el último plano son exactamente los
     dos proyectos propios. El orden dentro de cada uno es el de seniority demostrada
     de `docs/perfil-publico.md`. */
